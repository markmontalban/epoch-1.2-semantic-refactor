# CMP-001 — Local vs. Frontier Comparison Protocol
...
writer or a longer answer to conceal unsafe claims. [Run card](run-card.md)
· [DR-30](../../decisions/2026-07-13-run-003-paired-model-comparison.md)

## Fair-run rules

1. Freeze `CMP-001-input.md`, prompt wording, source references, output
