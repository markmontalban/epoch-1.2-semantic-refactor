...
Assigned sprint:
QW36-01: Search "Gulf Coast Center" "employee wellness" and site:gulfcoastcenter.org ("Clinical Academy" OR "workforce development"). Find two sources that clarify whether workforce support is a current public priority. Report only observable facts.
...
No reviewed evidence cards yet. Workers must rely on their assigned public
search task and state uncertainty rather than inventing context.
