...
- **Give it one thought:** Add one sentence or any partial fields directly to
  [Growth Hypotheses](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/HYPOTHESES.md). It begins as `exploring`; Product defaults to MindfulText.
  When known, select a stable audience ID from the
  [ICP Registry](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/ICP-REGISTRY.md).
  [DR-24](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-direct-growth-hypotheses.md)
  [DR-28](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-icp-registry.md)
- **Prompt one agent:** manually choose Codex, Claude, or Hermes. Telegram is not involved. [Team config](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/v0.1.1.md)
...
- **Size only a clear segment:** once the agent can define the ICP by behavior
  ...
  scope would change the next decision. [DR-27](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-tam-first-market-sizing.md)
- **Aim it only when useful:** leave `Research: auto` or write a compact source,
  ...
  `discover`, or `watch` per hypothesis. [DR-25](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-research-controls-and-profile-watch.md)
- **Use evidence later:** the original four assets strengthen or overturn the hypotheses; they do not block the first draft. [DR-22](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-prototype-run-first.md)
- **Keep signals lightweight:** add a short signal under its hypothesis; use the
  [Signal Log](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/SIGNALS.md) only when repeated sources make a shared log useful.

### Run 002 — Segment Intelligence + Local Research Evaluation

- **It turns a segment into a research map:** Run 002 is active for `SEG-001 — Care-delivery organizations`. It maps public accounts, buyer groups, category language, positioning, and contradictions; local work is evaluated as an input, not its only result. [Run card](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-002/run-card.md)
...
- **No monitoring or outreach:** account intelligence is public, cited, and bounded; it is not a CRM, scraper, or autonomous watcher. [DR-29](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-13-segment-linked-runs.md)

### CDP-001 — Care-delivery customer development
...
- **Develop the segment without claiming validation:** `CDP-001` links
  ...
  marketing opportunities before any external action. [CDP-001](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/CDP-001.md)
- **Advance only through a separate gate:** a future public-research run or
  ...
  this plan does not authorize monitoring, outreach, or publishing. [DR-31](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-14-customer-development-plan.md)
...
- **Revisit only on need:** C4 becomes relevant only if you later want Telegram or autonomous Hermes behavior. [DR-22](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-prototype-run-first.md)
...
- **Read the compact summary:** Start with the confirmed facts, open decisions, and current platform state. [Current state](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/status/CURRENT-STATE.md)
- **Separate approval from execution:** Run 001 is approved; it becomes executable when a `GH-###` item exists and Mark names the manual agent/provider. [Run card](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/run-card.md)

### Confirm tracker ownership

- **Use positional checklist references:** Treat the master checklist as the current execution record and use its document-position references (`A1`, `B1a`, `C4b`, etc.) when assigning or reporting work. [Master checklist](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/MASTER-CHECKLIST.md)
- **Find decisions through the register:** Use the Decision Register to resolve every `DR-*` identifier to its dated approval source and current checklist mapping. [Decision Register](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/DECISION-REGISTER.md)
- **Check the Mark summary:** Read the short status block before entering the detailed phase-by-phase checklist. [Mark summary](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/MASTER-CHECKLIST.md)

### Recover approval context

- **Confirm evidence classification:** DR-13 retained all four evidence candidates as `external-okay`, subject to spot-check at import. [DR-13](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-11-run-001-approvals.md)
- **Confirm provider policy:** Mark names the provider/agent in the manual invocation prompt; Codex, Claude, and Hermes are usable in prototype mode. [DR-22](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-12-prototype-run-first.md)
- **Confirm spending boundary:** DR-16 allows only Mark-held manual testing within existing OpenRouter limits; agents remain fail-closed at $0 external and sandbox spend. [DR-16](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/decisions/2026-07-11-run-001-approvals.md)

### Start the prototype loop

- **Add a Growth Hypothesis:** Fill one sentence or any partial fields using only material safe for the selected agent. It begins as `exploring`. [Growth Hypotheses](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/HYPOTHESES.md)
- **Run a manual prompt:** Select Codex, Claude, or Hermes and ask it to fill gaps, research public sources, produce editable paths, and rank them. [Run 001 packet](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/UNBLOCK-PACKET.md)
...
```mermaid
flowchart TD
    A[One-line Growth Hypothesis] --> B[Manual agent prompt]
    B --> C[Agent fills gaps + researches]
    C --> D[3–5 editable opportunity paths]
    D --> E[Rank + identify evidence gaps]
    E --> F[Mark edits and selects next test]
    F --> G[Optional: import stronger evidence]
    F --> H[Optional: local-first comparison]
    H --> I[Optimize from observed results]
...
```mermaid
flowchart LR
    R[Growth Hypothesis<br/>safe to share] --> X[Manually selected agent<br/>Run 001]
    X --> O[Editable path cards, scorecard,<br/>evidence gaps]
    O --> T[trace.jsonl<br/>references/hashes only]
    L[Raw sensitive material] --> S[Seagate local-only store]
...
```mermaid
flowchart TB
    U[Mark / agent session] --> D[Model Ops Dashboard<br/>localhost:7070]
    D --> O[Ollama<br/>localhost:11434]
    D --> R[Router<br/>router.json]
    D --> Q[Dispatcher jobs<br/>jobs.db]
    D --> M[Residency manager<br/>residency.json + settings.json]
    D --> G[Dual gate]
    G --> GA[Gate A<br/>logic / risk]
    G --> GB[Gate B<br/>quality / intent]
    GA --> V{Surface-aware verdict}
    GB --> V
    V -->|external: either BLOCK blocks| Z[Do not ship]
    V -->|internal: lone BLOCK can warn| W[Review / proceed with warning]
...
```mermaid
flowchart LR
    P0[Prototype setup<br/>complete] --> R1[Run 001<br/>growth hypothesis → draft paths]
    R1 --> R2[Run 002<br/>segment intelligence]
    R2 --> R3[Run 003<br/>one-test validation packet]
    R3 --> F{Mark decides}
    F --> H[Hermes: bounded operator or manual]
    F --> D[Dashboard: expand or freeze]
    F --> MT[Manual market test or defer]
    MT --> C[Closeout / Epoch 2 plan]
```
...
| --- | --- | --- |
| [Epoch 1 lab folder](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/) | Working directory for the current lab scaffold; the planned `Projects/` move is not authorized or present. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/` |
...
| [Next-steps plan](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/planning/next-steps-plan.md) | Historical dependency plan and phase rationale; consult for context, not current status. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/planning/next-steps-plan.md` |
| [Stability observation](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/observations/2026-07-10-stability-observation.md) | Historical evidence for the old core failure; now background telemetry, not a Run 002 gate. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/observations/2026-07-10-stability-observation.md` |

### C. Run 001 execution package

| Resource | What it governs | Folder / path |
| --- | --- | --- |
| [Run 001 folder](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/) | The run-specific card, unblock packet, blackboard, and privacy-safe trace. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/` |
| [Run card](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/run-card.md) | Exact allowed inputs, provider rule, limits, stop conditions, outputs, and approval. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/run-card.md` |
| [Run 001 packet](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/UNBLOCK-PACKET.md) | Five-bullet founder-brief and manual-prompt handoff for the prototype run. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/UNBLOCK-PACKET.md` |
| [Blackboard](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/blackboard.md) | Working notes for the run; do not place raw sensitive data here. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/blackboard.md` |
| [Trace](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/trace.jsonl) | Reference/hash-only run trace; no raw inputs. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/runs/run-001/trace.jsonl` |
| [ICP Registry](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/ICP-REGISTRY.md) | Canonical audience IDs, buyer/channel distinction, founder-reported testing context, and adjacent segment candidates. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/ICP-REGISTRY.md` |
| [Growth Hypotheses](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/HYPOTHESES.md) | One-line or partial idea entry; it starts directly as `exploring`, then agents research and fill missing fields as working hypotheses. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/HYPOTHESES.md` |
| [Public Profile Watch](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/PUBLIC-PROFILE-WATCH.md) | Optional public-profile research watchlist, used only when a hypothesis sets `Profile tracking: watch`. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/PUBLIC-PROFILE-WATCH.md` |
| [Signal log](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/SIGNALS.md) | Channel-agnostic capture of evidence that strengthens, weakens, or reranks a path. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/SIGNALS.md` |
| [Revenue-signal scorecard](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/SCORECARD.md) | Approved five-dimension rubric, staleness rule, and signal ladder. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/growth/SCORECARD.md` |
| [Team configs folder](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/) | Current and superseded provider-routing configurations. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/` |
| [Team config v0.1.1](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/v0.1.1.md) | Approved no-default-provider rule. `v0.1.md` is superseded. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/v0.1.1.md` |
| [Team config v0.1 — superseded](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/v0.1.md) | Historical Claude-only configuration retained for audit; do not use for new work. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/team-configs/v0.1.md` |

### D. Working methods, templates, and validation

| Resource | What it is for | Folder / path |
| --- | --- | --- |
| [Research-to-signal workflow](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/workflows/research-to-signal.md) | The repeatable workflow from evidence to ranked testable paths. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/workflows/research-to-signal.md` |
| [Templates folder](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/) | Run card, path card, decision, and compaction templates. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/` |
| [Tools folder](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/) | Run creation and validation utilities. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/` |
| [Tools README](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/README.md) | Exact validator and new-run commands. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/README.md` |
| [Run-card template](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/run-card.md) | Required structure for a new run. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/run-card.md` |
| [Path-card template](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/path-card.md) | Required structure for a candidate ROI path. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/path-card.md` |
| [Decision template](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/decision.md) | Format for a dated decision record. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/decision.md` |
| [Compaction template](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/compaction.md) | Format for a durable context handoff. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/templates/compaction.md` |
| [New-run utility](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/new-run.py) | Creates the standardized run folder and draft card. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/new-run.py` |
| [Run-card validator](/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/validate-run-card.py) | Validates a run card before approval and execution. | `/Users/mgzm-studio/AI-Studio/Docs/mindfultext-epoch-1/tools/validate-run-card.py` |
