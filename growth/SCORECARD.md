...
- **Disconfirming evidence subtracts** — score the net, not the best case.
...
| 1 — Resonance | relevant discussion, reply, useful objection | ICP pain resonates |
| 2 — Buyer intent | qualified call, intro, pricing/pilot conversation | meaningful advancement |
| 3 — Commitment | LOI, payment, paid pilot | revenue outcome |

## Run evaluation checklist (per run)

From draft §8 + charter §14.6 (`lab-validation` measures):

- Clearer paths than before the run?
- Non-obvious angles surfaced?
- Testable next action per top path?
- Reusable artifact produced?
- Was the team-config combo worth its cost/latency?
- Evidence quality, decision usefulness, reproducibility, latency, cost — recorded in the run card.
